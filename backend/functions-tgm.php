 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Split
...
add_action( 'tgmpa_register', 'split_register_required_plugins' );
 ...
 */
function split_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => 'FullSingle Layouts by One Page Love',
			'slug'      => 'fullsingle',
			'required'  => true,
		),
	 ...
	 */
	$config = array(
		'id'           => 'split',                 // Unique ID for hashing notices for multiple instances of TGMPA.
